...
export class ServiceSystemClient {
  private axiosInstance: AxiosInstance;
  private retryService: RetryService;
  private circuitBreaker: CircuitBreaker;
  private readonly systemName = 'service';

  constructor() {
    this.axiosInstance = axios.create({
      baseURL: config.serviceApi.url,
  ...
  async getDocumentsByVin(
    ...
    try {
      logger.info('Calling Service System API', {
        correlationId,
        vin,
      ...
      logger.info('Service System API call successful', {
        correlationId,
        vin,
      ...
      logger.error('Service System API call failed', {
        correlationId,
        vin,
